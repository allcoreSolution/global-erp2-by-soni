...
const SupplierLedger = () => {
  ...
  const [transactions] = useState([
    { id: 'PUR-2026-11', date: '2026-09-02', particulars: 'Purchase - Raw Materials', refNo: 'PO-099', debit: 0, credit: 35000, balance: 40000 },
    { id: 'PAY-2026-08', date: '2026-09-04', particulars: 'Payment Made via Cheque', refNo: 'CHQ-112233', debit: 20000, credit: 0, balance: 20000 }
  ]);
    ...
    <div className="bg-white p-4 sm:p-6 rounded-lg border border-slate-200/70 shadow-sm min-h-screen space-y-6 font-sans">
      ...
      <div className="bg-slate-50 p-4 border border-purple-200 rounded-lg flex items-center gap-4 text-xs font-semibold text-gray-700 mb-4">
        ...
        <select className="border p-1.5 rounded min-w-[200px]">
          ...
          <option>Electroparts India</option>
        </select>
          ...
          <tbody className="divide-y divide-slate-100">
            {transactions.map(t => (
              <tr key={t.id} className="hover:bg-slate-50">
                ...
                <td className="p-3 font-mono font-bold text-purple-600">{t.id}</td>
                ...
                <td className="p-3 text-right font-bold text-blue-700">{t.balance.toLocaleString()} Cr</td>
              </tr>
            ))}
          </tbody>
        </table>
